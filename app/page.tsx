  ...
  return(
    <nav style={{position:"sticky",bottom:0,zIndex:100,backgroundColor:"rgba(10,10,10,.96)",backdropFilter:"blur(12px)",borderTop:`1px solid ${BD}`,display:"flex",padding:"8px 0 calc(8px + env(safe-area-inset-bottom))"}}>
      {items.map(it=>{
       ...
       const st={flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:4,background:"none",border:"none",cursor:"pointer",color:on?"#fff":"#666",textDecoration:"none",padding:"4px 0"} as const;
        return it.href
